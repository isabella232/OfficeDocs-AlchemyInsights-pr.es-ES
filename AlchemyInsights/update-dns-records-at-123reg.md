...
---
# <a name="update-dns-records-at-123-reg"></a>Actualizar los registros DNS en 123-reg

Use los vínculos siguientes para ayudarle a actualizar sus registros DNS

- [Crear registros DNS en 123-reg.co.uk](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-at-123-reg-co-uk?view=o365-worldwide)
