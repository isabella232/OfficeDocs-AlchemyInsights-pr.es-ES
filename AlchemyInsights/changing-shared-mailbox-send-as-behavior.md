---
title: Cambiar el comportamiento de envío como buzón compartido
ms.author: pebaum
author: pebaum
manager: scotv
ms.audience: Admin
...
ms.locfileid: "53950169"
---
# <a name="changing-shared-mailbox-send-as-behavior"></a>Cambiar el comportamiento de envío como buzón compartido
...
Para obtener más información, vea [Configure shared mailbox settings](https://docs.microsoft.com/microsoft-365/admin/email/configure-a-shared-mailbox#allow-everyone-to-see-the-sent-email-the-replies).
