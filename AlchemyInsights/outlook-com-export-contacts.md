...
4. En la parte inferior de la página, seleccione **Guardar** y "contacts.csv" se guardará en la carpeta descargas predeterminada. Para elegir dónde guardar el archivo. csv, seleccione la flecha junto a guardar y seleccione **Guardar como**.
