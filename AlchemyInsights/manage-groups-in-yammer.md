...
- **Restauración de grupos eliminados.** La restauración de grupos de Yammer es posible a través [de la restauración de un grupo de Microsoft 365 eliminado](https://docs.microsoft.com/microsoft-365/admin/create-groups/restore-deleted-group) los grupos no conectados no se pueden restaurar después de eliminarlos.
