...
---
# <a name="update-dns-records-at-namecheap"></a>Actualizar registros DNS en Namecheap

Use los vínculos siguientes para ayudarle a actualizar sus registros DNS

- [Crear registros DNS en Namecheap](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-at-namecheap?view=o365-worldwide)
