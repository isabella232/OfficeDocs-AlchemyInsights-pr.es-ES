...
---
# <a name="update-dns-records-at-dreamhost"></a>Actualizar registros DNS en Dreamhost

Use los vínculos siguientes para ayudarle a actualizar sus registros DNS.

- [Crear registros DNS en Dreamhost](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-at-dreamhost?view=o365-worldwide)
