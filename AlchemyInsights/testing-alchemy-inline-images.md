---
title: Probar imágenes en línea de Alchemy
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
---
# <a name="access-the-domains-page"></a>Acceder a la página Dominios

Para obtener acceso a la página de dominios, simplemente haga clic en este icono a continuación:
