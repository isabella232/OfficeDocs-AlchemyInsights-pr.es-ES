...
ms.locfileid: "47669409"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="d2fe4-102">Obtener acceso a la página dominios</span><span class="sxs-lookup"><span data-stu-id="d2fe4-102">Access the Domains Page</span></span>

<span data-ttu-id="d2fe4-103">Para obtener acceso a la página dominios, haga clic en este icono a continuación:</span><span class="sxs-lookup"><span data-stu-id="d2fe4-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="d2fe4-104">A continuación, puede Agregar, modificar o quitar el dominio.</span><span class="sxs-lookup"><span data-stu-id="d2fe4-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="d2fe4-105">Para obtener más información, consulte las [preguntas más frecuentes de los dominios.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="d2fe4-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
