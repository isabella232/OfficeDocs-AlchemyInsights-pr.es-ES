...
Como parte del proceso de mover el sitio web público de Microsoft 365 a otro proveedor de hospedaje, es probable que deba realizar cambios en los registros del dominio.
...
Para obtener más información, vea [actualizar registros DNS para mantener el sitio web con su proveedor de hospedaje actual](https://docs.microsoft.com/microsoft-365/admin/dns/update-dns-records-to-retain-current-hosting-provide).
