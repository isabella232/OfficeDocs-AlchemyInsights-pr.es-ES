...
ms.locfileid: "53962220"
---
# <a name="import-contacts"></a>Importar contactos

Antes de importar contactos a Outlook.com, deberá exportarlos desde su otro proveedor de correo electrónico como archivo .csv usuario. A continuación, siga las instrucciones siguientes.
...
.
2. En la parte superior de la página, seleccione **Administrar contactos** \> **de importación.**
3. Seleccione **Examinar,** vaya a la carpeta donde guardó los contactos exportados y seleccione **Abrir**.

Para obtener más información, vea [Importar contactos a Outlook.com](https://support.office.com/article/285a3b55-8d93-4ac8-93df-43fffd13b2f1?wt.mc_id=Office_Outlook_com_Alchemy).
