...
ms.locfileid: "53941277"
---
# <a name="solutions-to-common-aad-synchronization-problems"></a>Soluciones para los problemas comunes de sincronización de AAD
...
- [Implementar la sincronización de contraseña con la sincronización de Azure AD Connect](https://docs.microsoft.com/azure/active-directory/hybrid/how-to-connect-password-hash-synchronization)

**Los objetos sincronizados no aparecen o actualizan en línea**
