 ...
 **Nota:** Puede tener más de una dirección de correo electrónico para un usuario, pero solo se pueden usar alias de  *correo*  electrónico adicionales para recibir correo electrónico. Si necesita enviar correo electrónico con un alias, cree un [buzón compartido](https://docs.microsoft.com/microsoft-365/admin/email/create-a-shared-mailbox). De esta forma, se obtiene el alias para enviar y recibir correo.
